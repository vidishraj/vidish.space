...
const clients: Client[] = [
    ...
    {
        name: 'Raheee',
        shortDesc: 'Capacitor mobile app — attribution, Android parity, pipeline',
        initials: 'RH',
        logo: '/assets/clients/rahee_logo.avif',
        role: 'Frontend Lead (freelance)',
        duration: 'Ongoing · 2026 — (110+ hrs in Jun–Jul alone)',
        summary: [
            'Started as a rescue sprint (security hardening, TypeScript migration, reels-style video player, major app-size cut) — grew into ongoing frontend-led ownership.',
            'Rebuilt Meta ad-attribution natively: a custom Capacitor bridge for Install Referrer, App Tracking Transparency, and app events — attribution restored end-to-end.',
            'Brought Android to iOS parity: R8 minification + resource shrinking for a ~40% smaller bundle, faster cold start, native config hardening.',
            'Replaced flaky hosted CI with a reliable Xcode-archive → TestFlight pipeline and automated App Store review submission.',
        ],
        tech: ['React', 'TypeScript', 'Capacitor 7', 'iOS', 'Android', 'Meta SDK', 'CI/CD'],
    },
    {
        name: 'Cipherome',
    ...
    {
        name: 'SoulTalk',
        shortDesc: 'LLM wellness platform — solo, live on the App Store',
        initials: 'ST',
        logo: '/assets/clients/soultalk_logo.svg',
        role: 'Sole Developer',
        duration: '~6 months · 808 commits · live on the App Store',
        summary: [
            'Built the entire product end-to-end as sole developer: async FastAPI backend (~32k LOC Python), React Native iOS app, marketing site, and infrastructure — ~808 commits across 4 repos.',
            'Real-time streaming AI over WebSockets with mid-stream error recovery — 30-50% lower token cost and faster time-to-first-token.',
            'Durable Redis-backed job pipeline with idempotency keys and privacy-by-design (GDPR/CCPA export + hard-delete erasure).',
            'Shipped via Docker + GitHub Actions with migration auto-rollback; launched publicly on the Apple App Store (US + Canada) in Aug 2026.',
        ],
        tech: ['Python', 'FastAPI', 'React Native', 'PostgreSQL', 'Redis', 'AWS', 'Docker', 'CI/CD'],
    },
    {
        name: 'Nyxidiom',
