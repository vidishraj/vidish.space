    ...
    const content = [
        {
            ...
            img: "../../public/assets/akkountantModal/akkountant.png",
            content: (
                <div
        ...
        },
        {
            ...
            img: "../../public/assets/tripsplitModal/tripsplit.png",
            content: (
        ...
        },
        {
            ...
            img: "../../public/assets/vidishSpaceModal/vidishSpaceDark.png",
            content: (
                <div
        ...
        },
        {
            ...
            img: "../../public/assets/leetcodeToGitModal/gitLeet.jpeg",
            content: (
                <div
                    className="h-full w-full bg-[linear-gradient(to_bottom_right,var(--cyan-500),var(--emerald-500))] flex items-center justify-center text-white">
