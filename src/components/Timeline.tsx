...
export const Timeline = ({data, titleClassName, containerClassname}: {
    data: TimelineEntry[],
    ...
    return (
        <div
            ref={containerRef}
            className={cn("w-full bg-white dark:bg-neutral-950 font-sans md:px-10", containerClassname)}
        >
            <div ref={ref} className="relative max-w-7xl mx-auto"
                 style={{paddingBottom: lastHeight}}>
                {data.map((item, index) => (
                    <div
                        key={index}
