...
import akkountantData from '../assets/akkountantModal/akkountantInfo.json';
import tripsplitData from '../assets/tripsplitModal/tripsplitInfo.json';
import leetcodeToGitData from '../assets/leetcodeToGitModal/leetcodeToGitInfo.json';
import vidishSpaceData from '../assets/vidishSpaceModal/vidishSpaceInfo.json';
