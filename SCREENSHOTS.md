...
| ~~38~~ ✅ | `public/assets/projects/tripsplit/manifest.webp` | TripSplit · The solution | **DELIVERED** 2026-08-20 — Overseer: "show household"; both live trip IDs **solid-filled** (background-matched; join-address hygiene — an existence oracle, not a breach, per mayor's code read), rest raw |
| ~~39~~ ✅ | `public/assets/projects/tripsplit/telegraph.webp` | TripSplit · The Telegraph desk | **DELIVERED** 2026-08-20 — RAW per Overseer "raw is okay" (third-party name + messages ship with his clearance) |
| ~~40~~ ✅ | `public/assets/projects/tripsplit/ledger.webp` | TripSplit · A ledger, not an app | **DELIVERED** 2026-08-20 — raw except trip ID **solid-filled** (first fill sampled label ink and left a visible band; resampled card surface — verify fills visually, always) |
| ~~41~~ ✅ | `public/assets/projects/tripsplit/customs.webp` | TripSplit · Results | **DELIVERED** 2026-08-20 — RAW per Overseer clearance. Companion audit capture (itemised per-bearer totals) cleared but NOT placed — redundant with customs view; available if ever wanted |
